...
- 10/21の試遊会がDATフェスタ前に他チームのメンバーに見てもらえる最後の機会である。これを逃すと、ゲームを知らない人がちゃんと企画の意図に気付けるかや、操作性に問題がないのか、伝わりにくいところがどこかなどを知ることができなくなるので、この段階でゲームとして必要な要素は全て盛り込んでおく必要がある
