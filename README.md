...
- 進捗と残り作業の確認
  ...
  - C 残り作業の確認。裏世界の入り口を全て閉じることで一先ずクリアする方向で進める。それができて時間があったらボスの作成に着手。入り口をいくつか塞ぐとカットシーンで敵が異常を感知したようなストーリーを見せたり、新たな入り口が開いたりといったストーリー展開も考えられる。ゲーム本体を早めに完成させて、そのような付加要素を追加できるのが理想
  - D Slackの記載項目を確認
